...
const trainDataUrl = 'file://./resources/data/fashion-mnist_train.csv';
const testDataUrl = 'file://./resources/data/fashion-mnist_test.csv';
...
const run = async function () {
  ...
  const saveModelPath = 'file://./resources/model';
